...
object AppConfig {
    ...
    const val PREF_FRAGMENT_ENABLED = "enable"
    const val PREF_FRAGMENT_PACKETS = "tlshello"
    const val PREF_FRAGMENT_LENGTH = "10-30"
    const val PREF_FRAGMENT_INTERVAL = "0-1"
